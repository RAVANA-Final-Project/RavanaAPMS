 ...
 * @author dulanjaya
 */
public class SelectForeignCustomer extends javax.swing.JDialog {

    ForeignerBooking foreignerBooking;

    /**
     * Creates new form SelectCustomers
     */
    public SelectForeignCustomer(java.awt.Frame parent, boolean modal, ForeignerBooking foreignerBooking) {
        super(parent, modal);
        initComponents();
        this.foreignerBooking = foreignerBooking;
        loadCustomer();
    }
    ...
    private void loadCustomer() {
        try {
            ...
            ResultSet resultset = MySQL.execute("SELECT * FROM `customer` INNER JOIN `customer_type` ON "
                    + "`customer`.`customer_type_customer_type_id`=`customer_type`.`customer_type_id` WHERE `customer_type_name`='Foreign'");
    ...
    private void customerDataInitialize(int selectedRow) {
        ...
        if (this.foreignerBooking != null) {
            this.foreignerBooking.setCustomerName(customerName);
            this.foreignerBooking.setCustomerMobileAsVar(customerMobile);
        } else {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select a Foreign Customer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectForeignCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
