 ...
 * @author dulanjaya
 */
public class SelectLocalActivity extends javax.swing.JDialog {

    private LocalBooking localBooking;
     ...
     * @param parent
     */
    public SelectLocalActivity(java.awt.Frame parent, boolean modal, LocalBooking localBooking) {
        super(parent, modal);
        initComponents();
    ...
    private void loadActivity() {
        try {
            ...
            ResultSet resultset = MySQL.execute("SELECT * FROM `activity` INNER JOIN `customer_type` ON "
                    + "`activity`.`customer_type_customer_type_id`=`customer_type`.`customer_type_id` WHERE `customer_type_name`='Local' OR `customer_type_name`='Neutral'");
    ...
    private void activityDataInitialize(String activityName, int activityId, String price, String offer) {
        if (this.localBooking != null) {
            this.localBooking.setActivity(activityName);
            this.localBooking.setActivityIdAsVar(activityId);
            this.localBooking.setPriceAsVar(price);
            this.localBooking.setOfferAsVar(offer);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectLocalActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
