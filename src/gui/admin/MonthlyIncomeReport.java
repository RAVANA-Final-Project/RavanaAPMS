 ...
 * @author dulanjaya
 */
public class MonthlyIncomeReport extends javax.swing.JPanel {
     ...
     */
    public MonthlyIncomeReport(AdminDashBoard adminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "Admin/Reports/Income_Reports/Monthly_Income_Reports/Monthly_income_report_" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
