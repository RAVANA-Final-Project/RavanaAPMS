 ...
 * @author dulanjaya
 */
public class SelectForeignerActivity extends javax.swing.JDialog {

    private ForeignerBooking foreignerBooking;
     ...
     * @param parent
     */
    public SelectForeignerActivity(java.awt.Frame parent, boolean modal, ForeignerBooking foreignerBooking) {
        super(parent, modal);
        initComponents();
    ...
    private void loadActivity() {
        try {
            ...
            ResultSet resultset = MySQL.execute("SELECT * FROM `activity` INNER JOIN `customer_type` ON "
                    + "`activity`.`customer_type_customer_type_id`=`customer_type`.`customer_type_id` WHERE `customer_type_name`='Foreign' OR `customer_type_name`='Neutral'");
    ...
    private void activityDataInitialize(String activityName, int activityId, String price, String offer) {
        if (this.foreignerBooking != null) {
            this.foreignerBooking.setActivity(activityName);
            this.foreignerBooking.setActivityIdAsVar(activityId);
            this.foreignerBooking.setPriceAsVar(price);
            this.foreignerBooking.setOfferAsVar(offer);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectForeignerActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
