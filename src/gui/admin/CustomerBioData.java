 ...
 * @author dulanjaya
 */
public class CustomerBioData extends javax.swing.JPanel {
     ...
     */
    public CustomerBioData(AdminDashBoard adminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "Admin/Reports/Customer_Reports/All_customer_report_" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
