 ...
 * @author dulanjaya
 */
public class EmployeeBioDataForSuper extends javax.swing.JPanel {
     ...
     */
    public EmployeeBioDataForSuper(SuperAdminDashBoard superAdminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "SuperAdmin/Reports/Employee_Reports/All_employee_report_" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
