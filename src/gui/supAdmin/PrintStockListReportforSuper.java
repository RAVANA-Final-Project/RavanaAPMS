 ...
 * @author dulanjaya
 */
public class PrintStockListReportforSuper extends javax.swing.JPanel {
...
//    }
     ...
     */
    public PrintStockListReportforSuper(SuperAdminDashBoard superAdminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "SuperAdmin/Reports/Stock_Reports/Stock_report_" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
