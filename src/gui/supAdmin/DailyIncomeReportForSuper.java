 ...
 * @author dulanjaya
 */
public class DailyIncomeReportForSuper extends javax.swing.JPanel {
     ...
     */
    public DailyIncomeReportForSuper(SuperAdminDashBoard superAdminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "SuperAdmin/Reports/Income_Reports/Daily_Income_Reports/Daily_income_report_" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
