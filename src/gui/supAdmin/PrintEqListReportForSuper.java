 ...
 * @author dulanjaya
 */
public class PrintEqListReportForSuper extends javax.swing.JPanel {
...
//    }
     ...
     */
    public PrintEqListReportForSuper(SuperAdminDashBoard superAdminDashBoard) {
        initComponents();
    ...
    private void reportDataInitialize(int outputType) {
        if (jTable1.getRowCount() > 0) {
            ...
            if (userDecidion == JOptionPane.YES_OPTION) {
                ...
                String outputfileName = "SuperAdmin/Reports/Equipment_Reports/Equipment_List_Report" + new SimpleDateFormat("yyy-MM-dd_hh-mm-ss-a").format(new Date()) + "_Ravana_APMS";
